...
export const Validation = {
    ...
    phone: () => check('phone').isMobilePhone(<MobilePhoneLocale>'SL').withMessage('Phone number is invalid or outside the SL'),
    ...
    name: () => check('name').not().isEmpty().withMessage('Name is required!').isString().isLength({max: 1000}).withMessage('Name field should not be more than 1000 chars long!'),
